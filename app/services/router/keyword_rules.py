...
KEYWORD_RULES: List[Dict[str, Any]] = [
    ...
    {
        "intent": "ADD_PATIENT",
        "regex": r"\b(ضيف|أضف|اضف|تسجيل|مريض جديد|إضافة مريض|سجل|سجله|سجلي|سجلهولي|المريض الجديد)\b",
        "keywords": ["ضيف", "أضف", "اضف", "تسجيل", "مريض جديد", "سجل", "سجله", "سجلي", "سجلهولي", "المريض الجديد"],
